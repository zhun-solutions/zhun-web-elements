...
attr_context_mng_admin.addData("collection", new ItemData("collection","metadata"));
    ...
    let child_eles_fs=getfieldset("Referenced Elements");
    ...
    child_eles_fs.addData("rmd_e_o_e", new ItemData("rmd_e_o_e",true));
    child_eles_fs.addRelElementsOnType("exec_cntx",render_metada_on_event_exec_cntx.name, render_metada_on_event_exec_cntx);
    child_eles_fs.addRelElementsOnType("exec_data",render_metadata_mdi.name,render_metadata_mdi)
