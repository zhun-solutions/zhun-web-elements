...
const getViewProductAttributesTabel= ()=>{
    ...
    let nameCol= new Item();
        nameCol.name="Name";
        nameCol.addData('display_name',new ItemData('display_name',"Domain Name"));
        ...
        codeCol.name="code";
        codeCol.addData('display_name',new ItemData('display_name',"Domain Value"));
    ...
    //     viewProductDomainTable.addRelElementsOnType("columns",traineeRegistrationStatusCol.name,traineeRegistrationStatusCol);
        ...
        dataref.addData("collection",new ItemData("collection","product_attribute_metadata"));
        dataref.addData("data_type",new ItemData("data_type","PRODUCT_ATTRIBUTE"));
...
export { getViewProductAttributesTabel}