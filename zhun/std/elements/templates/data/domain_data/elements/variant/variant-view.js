...
const getViewProductVariantsTabel= ()=>{
    ...
    //     viewProductDomainTable.addRelElementsOnType("columns",traineeRegistrationStatusCol.name,traineeRegistrationStatusCol);
        ...
        dataref.addData("collection",new ItemData("collection","product_variant_metadata"));
        dataref.addData("data_type",new ItemData("data_type","PRODUCT_VARIANT"));
...
export { getViewProductVariantsTabel}