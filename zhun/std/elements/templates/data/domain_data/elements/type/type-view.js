...
const getViewProductTypesTabel= ()=>{
    ...
    //     viewProductDomainTable.addRelElementsOnType("columns",traineeRegistrationStatusCol.name,traineeRegistrationStatusCol);
        ...
        dataref.addData("collection",new ItemData("collection","product_type_metadata"));
        dataref.addData("data_type",new ItemData("data_type","PRODUCT_TYPE"));
...
export { getViewProductTypesTabel}