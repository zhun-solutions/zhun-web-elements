...
const getViewProductSubCategoriesTabel= ()=>{
    ...
    //     viewProductDomainTable.addRelElementsOnType("columns",traineeDurationCol.name,traineeDurationCol);
        ...
        catCol.addData('data_key',new ItemData('data_key','category-name'));
   ...
   let statusCol= new Item();
    ...
    //     viewProductDomainTable.addRelElementsOnType("columns",traineeRegistrationStatusCol.name,traineeRegistrationStatusCol);
        ...
        dataref.addData("collection",new ItemData("collection","product_sub_category_metadata"));
        dataref.addData("data_type",new ItemData("data_type","PRODUCT_SUB_CATEGORY"));
...
export { getViewProductSubCategoriesTabel}
