...
const getViewProductSubDomainsTabel= ()=>{
    ...
    let nameCol= new Item();
        ...
        let domain= new Item();
        domain.name="domain";
        domain.addData('display_name',new ItemData('display_name',"Domain"));
        domain.addData('data_key',new ItemData('data_key','domain'));
        domain.addData("is-sortable", new ItemData("is-sortable",true));
        domain.addData("column-index",new ItemData("column-index",3));
        viewProductDomainTable.addRelElementsOnType("columns",domain.name,domain);
    ...
    let statusCol= new Item();
        ...
        statusCol.addData("column-index",new ItemData("column-index",4));
    ...
    //     viewProductDomainTable.addRelElementsOnType("columns",traineeRegistrationStatusCol.name,traineeRegistrationStatusCol);
        ...
        dataref.addData("collection",new ItemData("collection","product_sub_domain_metadata"));
        dataref.addData("data_type",new ItemData("data_type","PRODUCT_SUB_DOMAIN"));
...
export { getViewProductSubDomainsTabel}